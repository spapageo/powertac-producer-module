...
final class SolarModel
{
                                              ...
                                              double solartime)
  {
    ...
    double res =
      (sin(toRadians(getSunDivergance(day))) * cos(toRadians(panelLatitude)) - cos(toRadians(getSunDivergance(day)))
                                                                               * sin(toRadians(panelLatitude))
                                                                               * cos(toRadians((12 - solartime) * 15)))
                                                    ...
                                                    double temperature)
  {
    ...
    if (altitudeAngle >= 15) {
      ...
      return (0.1594 + 0.0196 * altitudeAngle + 0.00002 * pow(altitudeAngle, 2))
             * p
  ...
  private static double equationOfTime (int day)
  {
    ...
    return 0.258 * cos(X) - 7.416 * sin(X) - 3.648 * cos(2 * X) - 9.228
           * sin(2 * X);
  }
